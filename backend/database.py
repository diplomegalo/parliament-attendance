...
def minute_exists_list(refs: List[str]) -> set:
    """
    Check which minutes exist in the database by their references.
    
    Args:
        refs: List of minute references to check
        
    Returns:
        Set of references that exist in the database
    """
    if not refs:
        return set()
